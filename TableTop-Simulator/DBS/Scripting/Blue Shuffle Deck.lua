function onLoad()
    self.UI.setXml([[
        <Panel width="664" height="175" position="0 0 -50" id="BlueDeckShuffle" active="false">
...
function onSubmit(player, value, id)
    ...
    Global.call("shuffleDeck", {DeckType = "Deck", Color = "Blue"})
    
    -- Correctly set the UI attribute to make the panel inactive
    self.UI.setAttribute("BlueDeckShuffle", "active", "false")
